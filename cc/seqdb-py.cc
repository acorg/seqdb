...
PYBIND11_PLUGIN(seqdb_backend)
{
    ...
    py::class_<Seqdb>(m, "Seqdb")
            ...
            .def("add_sequence", &Seqdb::add_sequence, py::arg("name"), py::arg("virus_type"), py::arg("lab"), py::arg("date"), py::arg("lab_id"), py::arg("passage"), py::arg("reassortant"), py::arg("sequence"), py::doc("adds sequence to the database, inserts new entry if necessary."))
