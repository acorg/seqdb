...
PYBIND11_MODULE(seqdb_backend, m)
{
    ...
    py::class_<SeqdbEntry>(m, "SeqdbEntry")
            ...
            .def_property_readonly("continent", static_cast<std::string (SeqdbEntry::*)() const>(&SeqdbEntry::continent))
            .def_property_readonly("country", static_cast<std::string (SeqdbEntry::*)() const>(&SeqdbEntry::country))
            .def_property_readonly("virus_type", static_cast<std::string (SeqdbEntry::*)() const>(&SeqdbEntry::virus_type))
