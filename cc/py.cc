...
PYBIND11_MODULE(seqdb_backend, m)
{
    ...
    py::class_<SeqdbSeq>(m, "SeqdbSeq")
            ...
            .def("amino_acid_at", &SeqdbSeq::amino_acid_at, py::arg("pos"), py::arg("return_dash_on_error") = false, py::doc("pos starts from 1"))
            ...
            .def("gene", static_cast<const std::string& (SeqdbSeq::*)() const>(&SeqdbSeq::gene))
    ...
    py::class_<Seqdb>(m, "Seqdb")
            ...
            .def("find_by_name", static_cast<SeqdbEntry* (Seqdb::*)(const std::string&)>(&Seqdb::find_by_name), py::arg("name"), py::return_value_policy::reference, py::doc("returns entry found by name or None"))
