...
// "A1":[('HA1',144,'S'), ('HA1',159,'Y'), ('HA1',225,'D'),    ('HA1',311,'H'), ('nuc',1491,'A'), ('HA1',171,'K'),    ('HA2',77,'V'), ('HA2',155,'E'), ('HA2',160,'N')], # formerly clade 3c2.a1
// "3c2":   [('HA1',144,'N'), ('HA1',159,'F'), ('HA1',225,'N'), ('HA1',160,'T'), ('HA1',142,'R')],
// "3c3.B": [('HA1',83,'R'), ('HA1',261,'Q'), ('HA1',62,'K'),    ('HA1',122,'D')],
// "A2": [('HA1',144,'S'), ('HA1',159,'Y'), ('HA1',225,'D'),    ('HA1',311,'H'), ('nuc',1491,'A'), ('nuc', 234, 'A'),     ('HA1',131,'K'), ('HA1',142,'K'), ('HA1',261,'Q')], # formerly clade 3
// "A3": [('HA1',159,'Y'), ('HA1',225,'D'), ('HA1',311,'H'),     ('nuc',1491,'A'), ('nuc',234,'A'), ('HA1',121,'K'),     ('HA1',144,'K')], # formerly clade 2
// "A4": [('HA1',159,'Y'), ('HA1',225,'D'), ('HA1',311,'H'),    ('nuc',1491,'A'), ('nuc',234,'A'), ('HA1',53,'N'),    ('HA1',144,'R'), ('HA1',171,'K'), ('HA1',192,'T'),    ('HA1',197,'H')]
...
static const std::vector<CladeDesc> sClades =
{
    ...
    {"3C3", {{158, 'N'}, {159, 'F'}}},
    {"3C3A", {{158, 'N'}, {159, 'S'}}}, // {"3C3A", {{128, 'A'}, {142, 'G'}, {159, 'S'}}},
