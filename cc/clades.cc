...
static const std::vector<CladeDesc> sClades =
{
    ...
    {"3C3B", {/* {62, 'K'}, */ {83, 'R'}, {158, 'N'}, {261, 'Q'}}},
      // Sarah was unhappy with those difinitions taken from nextflu
      // {"3C3A", {"3C3A", {{128, 'A'}, {142, 'G'}, {159, 'S'}}},
      // {"A1", {{144, 'S'}, {159, 'Y'}, {171, 'K'}, {225, 'D'}, {311, 'H'}}},
      // {"A2", {{131, 'K'}, {142, 'K'}, {144, 'S'}, {159, 'Y'}, {225, 'D'}, {261, 'Q'}, {311, 'H'}}},
      // {"A3", {{121, 'K'}, {144, 'K'}, {159, 'Y'}, {225, 'D'}, {311, 'H'}}},
      // {"A4", {{53, 'N'}, {144, 'R'}, {159, 'Y'}, {171, 'K'}, {192, 'T'}, {197, 'H'}, {225, 'D'}, {311, 'H'}}},
